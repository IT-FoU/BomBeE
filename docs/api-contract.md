...
| GET | `/v1/stores/:storeId/checklist` | Onboarding checklist flags only (`getChecklist`) |
...
| GET | `/v1/stores/quality/rolling-counts` | Rolling 30-day quality counts for a store |
| POST | `/v1/ops/stores/quality/mock-suspend` | Local/mock direct `quality.suspend` |
...
| POST | `/v1/ops/packing-deadlines/mock-mark-packed` | Local/mock schedule packing deadline + mark packed |
...
| GET | `/v1/audit/customer-pii-access` | List customer PII access logs (local ops) |
| POST | `/v1/ops/audit/mock-customer-pii-access` | Local/mock log customer PII access |
