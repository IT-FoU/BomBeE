...
| P2-B2 | Customer OTP against real API (still mock SMS locally) | Wire `/v1` auth routes |
| P2-B3 | Legal Lo/En copy human review | KI-12-03 |
| P2-B4 | Expand OpenAPI from `docs/api-contract.md` | When HTTP surface grows |
| P2-B5 | Performance budgets in CI (bundle size check) | ADR 0004 |
